...
static void set_battery_status(struct zmk_widget_status *widget,
    ...
    widget->state.battery_right = state.right_level;
    widget->state.battery_right_connected = state.right_connected;
...
static uint8_t last_right_level;
...
static struct battery_status_state battery_status_get_state(const zmk_event_t *eh) {
    ...
    if (eh != NULL) {
        ...
        if (pev != NULL) {
            last_right_level = pev->state_of_charge;
